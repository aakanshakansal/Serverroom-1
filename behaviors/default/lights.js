class LightPawn {
    setup() {
        ...
        */
        ...
        sun.shadow.radius = -40;
        group.add(sun);
        this.lights.push(sun);

        const blueLight = new THREE.HemisphereLight(0x44449a, 0.9);
        blueLight.position.set(1, 100, 150);
        group.add(blueLight);
        this.lights.push(blueLight);
        // const blackLight = new THREE.RectAreaLight(0x00ffff, 0.5,780,50);
        // // blackLight.position.set(1, 100, 150);
        // group.add(blackLight);
        // this.lights.push(blackLight);

        const redLight = new THREE.HemisphereLight(0x9f4444, 0.35);
